...
Item {
    ...
    readonly property color clockColor:
      ...
      : (config.clockTint ? config.clockTint : fgColor)
    ...
    Image {
        ...
        cache: false
        asynchronous: true
        // Sin sourceSize a propósito: el PNG viene a 720x450 y el escalado a
        // pantalla completa lo hace la GPU (bilineal, gratis, y suaviza más el
        // desenfoque). Fijar sourceSize obligaría a reescalarlo en CPU al
        // decodificar, que es justo el coste que queremos evitar.
    ...
    Column {
        ...
        Text {
            ...
            font.pixelSize: Math.round(root.height * root.clockScale)
            font.weight: root.clockWeight
            // Tracking negativo en los tamaños grandes, como pide el HIG.
            font.letterSpacing: -Math.round(root.height * root.clockScale * 0.02)
    ...
    Rectangle {
        ...
        width: bbContent.implicitWidth + (root.bookBarCompact ? 28 : 40)
